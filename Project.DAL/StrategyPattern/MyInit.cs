    ...
    public class MyInit : CreateDatabaseIfNotExists<MyContext>
    {
        protected override void Seed(MyContext context)
        {
            ...
            for (int i = 2; i < 12; i++)
            {
                ...
                apu.ID = i; // birebir ilişki var AppUser ların ID leri ile buraları birleşmeli, 1 numarali ID adminde o yüzden 2 den başladık ve 12 ye kadar giderek 10 AppUser 10 AppUserProfile ile eşlendi.
