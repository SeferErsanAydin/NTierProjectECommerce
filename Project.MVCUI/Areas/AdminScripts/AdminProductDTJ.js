...
function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Add Product:</td><td> <a title = "Contents" href="/Admin/Product/AddProduct/" class="btn btn-primary">Add Product Page</a></td></tr>';
   
    sOut += '<tr><td>Image:</td><td>'+aData[6]+'</td></tr>';
    sOut += '</table>';
